...
class ConditionalUnet1D(nn.Module):
    ...
    def forward(self, sample: torch.Tensor, timestep: Union[torch.Tensor, float, int], local_cond=None, global_cond=None):
        ...
        for idx, (resnet, resnet2, upsample) in enumerate(self.up_modules):
            ...
            x = resnet2(x, global_feature)
            x = upsample(x)
            # Inject the second local feature at full temporal resolution.
